...
urlpatterns = [
    ...
    path('event/<int:event_id>/archive/', archive_event, name='archive_event'),
    path('event/<int:event_id>/unarchive/', unarchive_event, name='unarchive_event'),
    path('event/<int:event_id>/delete/', delete_event, name='delete_event'),
    path('event/<int:event_id>/gallery/add/', add_gallery_images, name='add_gallery_images'),
